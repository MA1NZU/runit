...
export default async function BugsPage() {
  ...
  const severityConfig = {
    critical: { color: 'text-red-400 border-red-400', label: '🔴 Critical' },
    high:     { color: 'text-orange-400 border-orange-400', label: '🟠 High' },
    medium:   { color: 'text-yellow-400 border-yellow-400', label: '🟡 Medium' },
    low:      { color: 'text-green-400 border-green-400', label: '🟢 Low' },
  }
